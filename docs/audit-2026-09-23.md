...
Nachtrag: Die ursprünglichen Befunde bleiben hier als Prüfstand erhalten. Die anschließenden Korrekturen sind in `AGENTS.md` dokumentiert; für G2 und G3 siehe [Nachprüfung der Rundungen und Sockelfuge](rounding-2026-09-23.md). Die spätere [BOSL2-Umstellung und aufrechte Ladeplatine](bosl2-charger-2026-09-23.md) sind separat nachgeprüft. Den aktuellen Aufbau von Filterstütze, Platinenhaltern, Schalterfreiraum und Deckelverschraubung beschreibt der [Hardware-Nachtrag](hardware-2026-09-23.md).
