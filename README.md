...
![Head-to-base fastening: four screws down into the base, with exposed front heads](img/09_head_mount.png)
...
- Four M3 × 8 screws secure the corner regions of the joint directly into the base. All four point down in the same direction; the front inserts sit in raised bosses behind the front wall. Their screw heads are exposed above flat seats. Reach the front pair through the empty intake with a small bit ratchet and fit the rear pair before the fan and cover. The soft mat bends locally over the front screw heads. All four seats have a direct supporting face behind them.
