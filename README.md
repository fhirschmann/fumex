...
The charge module rides in that airflow: it stands upright on the head floor in a small screwed-on holder, heatsink towards the fan and a few millimetres behind the blades. Nothing sticks out of the housing, its heat never reaches the cell, and the back cover comes off without it. The holder is a separate part because anything standing in the plenum blocks the fan on its way out — unscrew two M3 and it lifts away.
...
| `chg_holder` charge module holder | 1 | PETG black | 37.4 × 5.8 × 20 | base plate on the bed |
...
All parts are in the Bambu Studio project [`stl/fumex_all_parts.3mf`](stl/fumex_all_parts.3mf): plate 1 head, ballast lid and module holder, plate 2 base and back cover, plate 3 grey parts, plate 4 TPU feet. Filaments: 1 PETG black, 2 PETG grey, 3 TPU. No part mixes colours, so there is no prime tower. Every part prints without supports. Bambu Studio estimates about **0.48 kg and 16.4 hours** in total (head 230 g, base 119 g, back cover 56 g, cassette 52 g, ballast lid 7 g, knob 6 g, module holder 1 g, feet 4 × 1.5 g).
...
| Aluminium heatsink 14 × 14 × 6 mm with an insulating silicone thermal pad | 1 | – | on the metal pad behind the charger IC, facing the fan and standing in its exhaust; the pad must cover the whole heatsink face |
...
| Heat-set inserts Ruthex RX-M3x5.7 | 18 | [ruthex.de](https://www.ruthex.de) | 4 fan, 4 back cover, 4 head screws, 4 feet, 2 module holder |
| M3 × 30, ISO 7380 Torx | 4 | – | fan; the frame alone is 25 mm thick, so nothing shorter reaches a thread |
| M3 × 8, ISO 7380 Torx | 14 | – | back cover (4), head onto the base (4), feet (4), module holder (2) |
...
- The CN3058E on the module is a linear charger: at 1 A from 5 V it turns about 1.6 W into heat, and it does that exactly while the battery is charging — which is when a LiFePO4 cell least wants to be warm. So the board does not live in the sealed bay at all: it stands in the plenum on the head floor, heatsink a few millimetres behind the fan. Run the fan while charging and that heatsink sits in a 130 m³/h stream; with the fan off it is at least in the open head instead of beside the cell. Its six wires drop straight through the notch in the head floor into the base.
...
5. Stick the insulating pad onto the metal pad on the back of the charge module and the heatsink onto the pad. Slide the board down into the grooves of its holder, heatsink towards the fan, and run one cable tie through the two tunnels over it. Screw the holder to the head floor with 2 × M3 × 8.
