...
VIEWER = dict(
    ...
    parts=[("base", "Base", "black", "#2b2d30", "1x", [0, 0, 0]),
           ("head", "Head", "black", "#2b2d30", "1x", [0, -0.36, 1.35]),
           ("head_back", "Back cover", "black", "#2b2d30", "1x", [0, 2.3, 0.6]),
           ("cassette", "Filter cassette", "grey", "#8c9196", "1x", [0, -1.55, 1.0]),
           ("knob", "Speed knob", "grey", "#8c9196", "1x", [0, -0.6, 0]),
           ("feet", "Feet", "tpu", "#1a1b1d", "4x", [0, 0, -0.6]),
           ("fan_visual", "Fan 120 x 25", "bought", "#3f4247", "1x", [0, 0.5, 1.35]),
           ("filter", "Filter mat 120 x 120 x 17", "bought", "#5a5f66", "1x", [0, -0.9, 1.1]),
